              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:amansinghthapa33@gmail.com"
                      className="text-white hover:text-indigo-300 transition-colors"
                    >
                      amansinghthapa33@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex gap-2 mt-6">
                  <a
                    href="https://github.com/aman-singh78"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  <a
                    href="https://www.linkedin.com/in/aman-singh-thapa-1ba056373/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-white transition-colors"
                  >
                  ...
                  <a
                    href="https://x.com/AmanSinghThapa"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-white transition-colors"
                  >
                  ...
                  <a
                    href="https://leetcode.com/aman_singh_thapa/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-2 rounded-lg bg-gray-700 hover:bg-gray-600 text-white transition-colors"
                  >
